...
const STREAMS: Stream[] = [
  ...
  },
  {
    ...
    subtitle: "Physical AI Platform · SaaS Licensing",
    bullets: [
      "Physical AI platform licensing",
      "Module-by-module adoption",
      "Federated learning across all deployments",
    ],
    alpha: 0.12,
  },
  {
    ...
    subtitle: "Partner Facilities · LMM Factory Kit",
    bullets: [
      "Physical AI at partner facilities",
