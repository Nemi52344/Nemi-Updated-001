      ...
      <div className="relative overflow-hidden">
        ...
        <div className="w-full h-full relative">
          ...
          <img
            ...
            style={{ transition: "transform 0.6s cubic-bezier(0.16,1,0.3,1)" }} loading="lazy" decoding="async"
          />
        </div>
      </div>
    </section>
            ...
            <ScrollReveal key={s.title} delay={i * 100}>
              <div className="bg-background hover:bg-card transition-colors duration-300 cursor-default h-full" style={{ padding: "2rem" }}>
                <div className="bg-card" style={{ height: 140, marginBottom: "1.5rem", overflow: "hidden", borderLeft: `2px solid ${henry}`, padding: 0 }}>
                  <img src={s.img} alt={s.title} style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.65, transition: "transform 0.6s cubic-bezier(0.16,1,0.3,1)" }} className="hover:scale-105" loading="lazy" decoding="async" />
                </div>
