                  ...
                  {(dropOtpStage === "sent" || dropOtpStage === "verifying") && !isDropVerified && (
                    <div className="mt-2 flex flex-col sm:flex-row gap-2 items-stretch sm:items-center">
                      <input
                        ...
                        inputMode="numeric"
                        value={dropOtpCode}
                        onChange={(e) => setDropOtpCode(e.target.value.replace(/\D/g, "").slice(0, 6))}
